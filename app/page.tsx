...
export default function Home() {
  ...
  const handleSignIn = async () => {
    try {
      ...
      setAuthError('Authentication is not configured. Please check Firebase settings.');
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex flex-col items-end">
              ...
              {authError && (
                <p className="text-red-600 text-sm mt-2 max-w-xs text-right">
                  {authError}
                </p>
              )}
            </div>
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                <p className="text-sm text-yellow-700">
                  ...
                  To enable full functionality, please set up your Firebase project and update the environment variables.
                  <Link href="/dashboard" className="font-medium underline hover:text-yellow-800 ml-2">
                    View Demo Dashboard →
                  </Link>
                </p>
              </div>
